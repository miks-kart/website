        ...
        <div className="page-container md:!pt-16 md:!pb-9 !pb-5 wide">
          <div className="grid gap-5 md:gap-3 md:grid-cols-2">
            ...
            <div className="flex direction-columnt justify-center">
              ...
              <p>Приезжайте по адресу: <span className="text-red">г. Рязань, пос. Секиотово <br />Комплекс расположен в 15 минутах от центра Рязани по Михайловскому шоссе.Поворот с трассы М5 на г. Тула.</span></p>
