  ...
  return (
    <AnchorSmoothScroll>
      ...
      <section className="w-screen bg-white">
        <div className="page-container md:!pt-16 md:!pb-9 !pb-5 wide">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            <div className="flex direction-column bg-grey justify-space-between">
            ...
            <div className="flex direction-column bg-grey justify-space-between">
              ...
              <p className="text-small">Приезжайте по адресу: <span className="text-red">г. Рязань, пос. Секиотово <br />Комплекс расположен в 15 минутах от центра Рязани по Михайловскому шоссе.Поворот с трассы М5 на г. Тула.</span></p>
      ...
      <section className="w-screen bg-white">
        <div className="page-container md:!pt-16 md:!pb-9 !pb-5 wide">
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
            <div className="flex direction-column md:direction-row bg-grey align-items-center">
      ...
      <section>
        <div className="page-container md:!pt-16 md:!pb-9 !pb-5 wide text-center">
          ...
          <a className="theme-button" href="tel:+7 (495) 640 33 02">+7 (495) 640 33 02</a>
        </div>
      </section>
    </AnchorSmoothScroll>
  );
