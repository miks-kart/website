...
# Убрал дублирование headingOne, statementOne, statementTwo
...
# Новые блоки с логотипами - используем text вместо title
featureBlocks:
  - logo: /images/skolkovo-logo.svg
    text: "МИКС КАРТ – официальный резидент инновационного центра Сколково в области разработки микроавтомобилей «карт»."
  - logo: /images/EPS_rgb.svg
    text: "Продукция разработана при поддержке ФГБОУ «Фонд содействия развитию малых форм предприятий в научно-технической сфере» (Фонд содействия инновациям) в рамках реализации проекта: «Разработка унифицированных компонентов для обеспечения модульной компоновки микроавтомобилей карт»"
