...
textOne: >- Уникальный электрический прокатный карт, который отлично подходит новичкам, любителям и опытным пилотам, для использования в помещении и на открытом треке, для проката и проведения соревнований.
